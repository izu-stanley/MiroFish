    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              Even with just a paragraph of text, <span class="highlight-bold">MiroFish</span> can automatically generate a parallel world of up to <span class="highlight-orange">millions of Agents</span> from real-world seeds. Inject variables from a god's-eye view to find<span class="highlight-code">“local optima”</span>
            </p>
            <p class="slogan-text">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parse prediction needs & dynamic memory updates</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent with rich tools interacts deeply with post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction in natural language (e.g. If a university announces policy X, how might students and faculty react?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
