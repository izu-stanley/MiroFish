        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 (Start Simulation) and Step 5 (Deep Interaction) must be started from a running session; they do not support history playback.</span>
            </div>
          </div>
        </div>
      </Transition>
